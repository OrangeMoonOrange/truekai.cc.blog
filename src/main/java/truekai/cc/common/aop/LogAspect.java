...
public class LogAspect {
    ...
    @Pointcut("@annotation(truekai.cc.common.aop.LogAnnotation)")
    public void pt(){}
    ...
    private void recordLog(ProceedingJoinPoint joinPoint, long time) throws Exception{
        ...
        Class<? extends Convert> convert = logAnnotation.convert();
        Convert logConvert = convert.newInstance();
        OperateLogDo operateLogDo = logConvert.convert(null);
